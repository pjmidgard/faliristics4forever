...
<div id="horizontal_menu" style="border-style: solid; border-width: 1px; padding-left: 1px; padding-right: 1px;
 padding-top: 1px; padding-bottom: 1px">
		...
		//////////////////////////////////////////////////////
			...
			&nbsp;You need fill <br>&nbsp;all six column.<br>&nbsp;Also, if <br>&nbsp;you choose that <br> 
			&nbsp;you want to <br>&nbsp;be admin. You <br>&nbsp;need to ask <br>&nbsp;about that <br>&nbsp;password&nbsp;
			<br>&nbsp;the admin. After <br>&nbsp;type it. 
			</div>  
...
$varN3f = password_hash($varN3, PASSWORD_DEFAULT);
	$sql = "insert into Students values('$varN1','$varN4','$varN5','$varN6','$varN3f',1)";}

if($dlin1>0 && $dlin2>0 && $dlin3>0 && $dlin4>0 && $dlin5>0 && $dlin6>0 && $admin =="0" && $varN2==$varN3)
{
	$varN3f = password_hash($varN3, PASSWORD_DEFAULT);
	$sql = "insert into Students values('$varN1','$varN4','$varN5','$varN6','$varN3f',0)";}
/*
