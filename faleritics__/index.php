...
display: inline;
 ...
 <a href='https://www.symptoma.ro/'>symptoma</a> <script type='text/javascript' src='https://www.freevisitorcounters.com/auth.php?id=e8efe2935376c8d8bd852bdfbab8b915e828d621'></script>
<script type="text/javascript" src="https://www.freevisitorcounters.com/en/home/counter/675468/t/0"></script>
...
<div id="horizontal_menu" style="border-style: solid; border-width: 1px; padding-left: 1px;
 padding-right: 1px; padding-top: 1px; padding-bottom: 1px">
		...
		//////////////////////////////////////////////////////
			...
			&nbsp;&nbsp;Read roles. <br>&nbsp; After <br>&nbsp;please, rigister and <br>&nbsp;after You <br>
...
$items->execute();
    ...
    echo 'Invalid password.';$df=0;
		...
		if($df==0){echo '<font color="#E2000D"> <br> Password or login wrong please try again !!! </font>';} 
		//////
if($df==1)
{
//session
